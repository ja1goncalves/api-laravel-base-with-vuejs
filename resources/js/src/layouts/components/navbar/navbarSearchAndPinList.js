...
export default {
  pages: {
    ...
    data: [
      ...
      {title: "E-mail",                     url: "/apps/email",                         icon: "MailIcon",           is_bookmarked: false},
      {title: "Calendario",                 url: "/apps/calendar/vue-simple-calendar",  icon: "CalendarIcon",       is_bookmarked: false},
